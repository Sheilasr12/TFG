...
class GaitInstructionResponse {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new GaitInstructionResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GaitInstructionResponse(null);
...
GaitInstructionResponse.Constants = {
  GAIT_REJECTED: -1,
  GAIT_ACCEPTED: 0,
  GAIT_FINISHED: 1,
}

module.exports = GaitInstructionResponse;
