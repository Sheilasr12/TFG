...
#ifndef COMPUTED_TORQUE_CONTROLLER_TOLERANCES_H
#define COMPUTED_TORQUE_CONTROLLER_TOLERANCES_H
                                               ...
                                               const std::vector<std::string>& joint_names)
{
  ...
  direct_dynamic_controller::SegmentTolerances<Scalar> tolerances;
