...
"""autogenerated by genpy from march_shared_msgs/Error.msg. Do not edit."""
import codecs
import sys
...
class Error(genpy.Message):
  _md5sum = "33219ea76fe005430968f80b14f32d57"
  _type = "march_shared_msgs/Error"
  _has_header = True  # flag to mark the presence of a Header object
  _full_text = """# Readable message that describes the error
Header header
...
"""
  ...
  __slots__ = ['header','error_message','type']
