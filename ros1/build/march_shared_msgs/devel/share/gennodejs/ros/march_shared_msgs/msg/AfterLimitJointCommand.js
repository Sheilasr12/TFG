...
class AfterLimitJointCommand {
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new AfterLimitJointCommand(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new AfterLimitJointCommand(null);
...
module.exports = AfterLimitJointCommand;
