...
#ifndef MARCH_SHARED_MSGS__SRV__DETAIL__CAPTURE_POINT_POSE__FUNCTIONS_H_
#define MARCH_SHARED_MSGS__SRV__DETAIL__CAPTURE_POINT_POSE__FUNCTIONS_H_
...
/// Initialize srv/CapturePointPose message.
/**
...
/// Finalize srv/CapturePointPose message.
/**
...
/// Create srv/CapturePointPose message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * march_shared_msgs__srv__CapturePointPose_Request__init().
...
/// Destroy srv/CapturePointPose message.
/**
 * It calls
 * march_shared_msgs__srv__CapturePointPose_Request__fini()
...
/// Initialize array of srv/CapturePointPose messages.
/**
...
/// Finalize array of srv/CapturePointPose messages.
/**
 * It calls
 * march_shared_msgs__srv__CapturePointPose_Request__fini()
...
/// Create array of srv/CapturePointPose messages.
/**
 * It allocates the memory for the array and calls
 * march_shared_msgs__srv__CapturePointPose_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/CapturePointPose messages.
/**
 * It calls
 * march_shared_msgs__srv__CapturePointPose_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * march_shared_msgs__srv__CapturePointPose_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_march_shared_msgs
...
/**
 * It calls
 * march_shared_msgs__srv__CapturePointPose_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_march_shared_msgs
...
/**
 * It allocates the memory for the array and calls
 * march_shared_msgs__srv__CapturePointPose_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_march_shared_msgs
...
/**
 * It calls
 * march_shared_msgs__srv__CapturePointPose_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // MARCH_SHARED_MSGS__SRV__DETAIL__CAPTURE_POINT_POSE__FUNCTIONS_H_
