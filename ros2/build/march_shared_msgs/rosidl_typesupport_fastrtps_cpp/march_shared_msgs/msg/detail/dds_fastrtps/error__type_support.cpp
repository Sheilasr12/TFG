...
#include "march_shared_msgs/msg/detail/error__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const march_shared_msgs::msg::Error & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  march_shared_msgs::msg::Error & ros_message)
{
  // Member: header
...
{
  auto typed_message =
    static_cast<const march_shared_msgs::msg::Error *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<march_shared_msgs::msg::Error *>(
    untyped_ros_message);
...
{
  return &march_shared_msgs::msg::typesupport_fastrtps_cpp::_Error__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, march_shared_msgs, msg, Error)() {
  return &march_shared_msgs::msg::typesupport_fastrtps_cpp::_Error__handle;
}
