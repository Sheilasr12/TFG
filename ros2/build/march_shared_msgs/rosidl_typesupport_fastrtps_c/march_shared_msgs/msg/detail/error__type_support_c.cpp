...
#include "march_shared_msgs/msg/detail/error__rosidl_typesupport_fastrtps_c.h"
...
using _Error__ros_msg_type = march_shared_msgs__msg__Error;
...
static uint32_t _Error__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_march_shared_msgs__msg__Error(
...
{
  return max_serialized_size_march_shared_msgs__msg__Error(
    full_bounded, 0);
}
