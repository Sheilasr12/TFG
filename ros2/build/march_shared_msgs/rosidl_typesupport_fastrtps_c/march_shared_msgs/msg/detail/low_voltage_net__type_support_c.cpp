...
#include "march_shared_msgs/msg/detail/low_voltage_net__rosidl_typesupport_fastrtps_c.h"
...
using _LowVoltageNet__ros_msg_type = march_shared_msgs__msg__LowVoltageNet;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _LowVoltageNet__ros_msg_type * ros_message = static_cast<const _LowVoltageNet__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
  ...
  void * untyped_ros_message)
{
  ...
  _LowVoltageNet__ros_msg_type * ros_message = static_cast<_LowVoltageNet__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _LowVoltageNet__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_march_shared_msgs__msg__LowVoltageNet(
...
{
  return max_serialized_size_march_shared_msgs__msg__LowVoltageNet(
    full_bounded, 0);
}


static message_type_support_callbacks_t __callbacks_LowVoltageNet = {
...
static rosidl_message_type_support_t _LowVoltageNet__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_LowVoltageNet,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, march_shared_msgs, msg, LowVoltageNet)() {
  return &_LowVoltageNet__type_support;
}
