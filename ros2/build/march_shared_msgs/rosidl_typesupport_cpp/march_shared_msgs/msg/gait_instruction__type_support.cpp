...
static const _GaitInstruction_type_support_symbol_names_t _GaitInstruction_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, march_shared_msgs, msg, GaitInstruction)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, march_shared_msgs, msg, GaitInstruction)),
  }
};
...
{
  return &::march_shared_msgs::msg::rosidl_typesupport_cpp::GaitInstruction_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, march_shared_msgs, msg, GaitInstruction)() {
  return get_message_type_support_handle<march_shared_msgs::msg::GaitInstruction>();
}
