...
bool march_shared_msgs__msg__low_voltage_net__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("march_shared_msgs.msg._low_voltage_net.LowVoltageNet", full_classname_dest, 52) == 0);
  }
  march_shared_msgs__msg__LowVoltageNet * ros_message = _ros_message;
  {  // name
...
{
  /* NOTE(esteve): Call constructor of LowVoltageNet */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("march_shared_msgs.msg._low_voltage_net");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LowVoltageNet");
